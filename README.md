This is one of my last year projects in Sakarya University written in C#.
...
These butons here work as a normal cash register. After you enter the number you press on either Barcod, adet or ödenen to spesify what that number means:

<img width="529" height="213" alt="image" src="https://github.com/user-attachments/assets/dacbe849-43a4-4bb5-8eac-b48c0b8ab4e2" />
...
Pressing any of these butons will finalize the sellout procedure:

<img width="392" height="148" alt="image" src="https://github.com/user-attachments/assets/20ffc300-d86c-4d9d-a5d2-bdb26a78352d" />

With Diğer Ürün buton you can add a product that does not have barcod.
With İade you can make a register the return of the product
With Temizle you can just clean all the registered items and begin again


Moving on to the next tab which is Genel Rapor allows you to take a report of the recent activities as below:

<img width="2150" height="831" alt="image" src="https://github.com/user-attachments/assets/74ba39fb-12f2-414c-84a2-36dc45cd087a" />

You can click on Stok Durumu to get check stock status on products:
